...
class ChessGame(commands.commands.commands.commands.commands.commands.commands.Cog,
                MainCommands,
                PlayerCommands,
                ScoreboardCommands):
    """commands.commands.commands.commands.commands.commands.commands.Cog to Play chess!"""
