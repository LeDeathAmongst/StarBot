...
from starbot.core.utils import menus, predicates
...
class CustomHelp(Cog):
    ...
    async def handle_new_cog_entries(self, cog: Cog):
    ...
    # async def handle_cog_remove(self, cog: Cog):
    #     # cog_name = cog.__class__.__name__
    #     pass
