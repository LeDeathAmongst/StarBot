...
class AIUser(
    ...
    ResponseHandler,
    RandomMessageTask,
    commands.commands.commands.commands.commands.Cog,
    ...
    @commands.commands.commands.commands.commands.commands.commands.commands.commands.commands.Cog.listener()
