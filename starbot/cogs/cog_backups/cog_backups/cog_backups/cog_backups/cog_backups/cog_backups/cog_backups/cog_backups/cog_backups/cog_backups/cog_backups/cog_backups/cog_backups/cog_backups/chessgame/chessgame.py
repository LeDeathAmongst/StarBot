...
class ChessGame(commands.commands.commands.commands.commands.commands.commands.commands.Cog,
                MainCommands,
                PlayerCommands,
                ScoreboardCommands):
    """commands.commands.commands.commands.commands.commands.commands.commands.Cog to Play chess!"""

    def __init__(self):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("None")
        self.logs = CogsUtils.get_logger("None")
        self.logs = CogsUtils.get_logger("None")
        self.logs = CogsUtils.get_logger("None")
        self.logs = CogsUtils.get_logger("None")
