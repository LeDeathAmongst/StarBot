...
﻿from Star_Utils import commands.commands.commands.commands.commands.Cog, Menu  # isort:skip
...
class RunCode(Cog):
    ...
    # @commands.commands.commands.commands.commands.Cog.listener()
    # async def on_assistant_cog_add(self, assistant_cog: typing.Optional[Cog] = None) -> None:  # Vert's Assistant integration/third party.
    #     schema = {
    #         "name": "execute_code",
