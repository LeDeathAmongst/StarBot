...
from starbot.cogs.mod.mod import Mod as ModClass
from starbot.cogs.mod.utils import is_allowed_by_hierarchy
from starbot.core import Config, app_commands, checks, commands, modlog
from starbot.core.bot import Red
from starbot.core.utils.chat_formatting import bold, box, humanize_timedelta
...
# https://github.com/flaree/Red-DiscordBot/blob/FR-custom-bankick-msgs/starbot/core/commands/converter.py#L207
...
class Mod(ModClass):
    ...
    def __init__(self, bot: Red):
        super().__init__(bot)
        self.logs = CogsUtils.get_logger("Mod")
        self.logs = CogsUtils.get_logger("Mod")
        self.bot: Red = bot
